...
L_DCF=2*1e3;                                    % Length of DCF (unit:m)
...
IA_inputmax=max(max(IA_input));
fA_input=fft(A_input);
figure
plot(t/1e-12,IA_input/IA_inputmax,'r');
...
%% Output image
figure
plot(t/1e-12,IA_image/IA_inputmax,'r-');
hold on
plot(t/1e-12,IA_input/IA_inputmax,'b--');
